<template>
  ...
  <template v-if="getBettingtable !== 'roulette'">
    <TrayComponent v-if="getBettingtable == 'niuniu' || getBettingtable == 'threecards'" />
    <Container002 :tableNumber="_table.tableNumber" v-if="getBettingtable !== 'niuniu' && getBettingtable !== 'threecards'"/>
    <RoadMapJS
      v-if="getBettingtable !== 'moneywheel' && getBettingtable !== 'roulette' && getBettingtable !== 'niuniu' && getBettingtable !== 'threecards' "
